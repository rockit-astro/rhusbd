...
setup(name='warwick.observatory.rhusb',
      version='0',
      packages = ['warwick.observatory.rhusb'],
      author='Paul Chote',
      description='Common backend code for the rhusb daemons',
      license='GNU GPLv3',
      author_email='p.chote@warwick.ac.uk',
      url='https://github.com/warwick-one-metre/rhusbd',
)
